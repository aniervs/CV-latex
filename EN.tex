...
\jobentry
	...
	{\href{https://leaguesofcode.com}{Leagues of Code}} % Employer
	{Software Engineering Intern} % Job title
	{As part of this internship, I'm part of the back-end team that is building a new platform, with materials, problems and an automatic grading system for teaching programming to kids from ground level to advanced level.
    We use \textbf{Laravel} as the main framework.} % Description

%------------------------------------------------

\jobentry
	{Current, from November 2021} % Duration
	{PT} % FT/PT (full time or part time)
	{\href{https://leaguesofcode.com}{Leagues of Code}} % Employer
	{Lecturer} % Job title
	{Starting from November 2021, I started working as a full time lecturer at Leagues of Code,
	teaching classes of programmig (introductory level and also competitive programmig) on weekends.
    } % Description
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Employer}{\href{https://www.rationalenterprise.com}{Rational Retention}}{spaceafter}
...
\parbox[top][0.11\textheight][c]{\linewidth}{ % Box to hold the colored box; change the fixed height as needed to match the box to the left
	\colorbox{shade}{ % Create colored box and specify background color
		\begin{supertabular}{@{\hspace{3pt}} p{0.05\linewidth} | p{0.775\linewidth}} % Start a table with two columns, the table will ensure everything is aligned
            ...
            % \raisebox{-1pt}{\faTelegram} & \href{https://t.me/aniervs}{https://t.me/aniervs} \\ % Telegram profile
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{2021}{\textbf{15th place -- SWERC ICPC}}{}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Beginner}{\LaTeX}{spaceafter}
	
	%------------------------------------------------
	
	\tableentry{Intermediate}{Php, Laravel, MySQL}{}
	\tableentry{}{Python, C++, Unix}{spaceafter}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\tableentry{Teaching}{Intro to Programming in Python}{}
	\tableentry{}{Leagues of Code Summer Camp -- 2021}{spaceafter}
...
\subsection{Deep Understanding oriented}

I believe that having a solid understanding of the areas where I work is the key to have a successfull result.
That's why I enjoy to learn deeply until the core, never forgetting the applications in distinct fields.

\subsection{Passionate}

I have been interested in Mathematics and Computing from an early age.
My education and participation in programming contests have cemented this interest into a passion.
I greatly enjoy solving algorithmic problems and applying mathematics in computing-related problems.
