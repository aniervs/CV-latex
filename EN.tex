...
\jobentry{}{}{}{Problemsetter}{
	I created problems for the Cuban Olympiad in Informatics (OCI) in multiple ocassions.
	I was problem setter for the Iberoamerican Olympiad in Informatics 2020 (CIIC 2020).
}
...
\begin{supertabular}{r l} % Start a table with two columns, the table will ensure everything is aligned
	...
	\qualificationentry
		...
		{} % Department
		{Pre-University Institute of Exact Sciences} % Institution
