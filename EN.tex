...
\jobentry
	...
	{Leagues of Code/Harbour.Space} % Employer
	{Software Engineering Intern} % Job title
	{As part of this internship, I'm building APIs for a new platform that hasn't been launched yet.
    I work on the backend team where we use Laravel as the main framework and mySQL as the main relational DBMS. } % Description
